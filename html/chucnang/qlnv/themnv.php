      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" onsubmit="return validateForm()" style="width:50vw; min-width:300px;">
            <div class="mb-3">
               ...
               <input type="text" class="form-control" name="id_nv" id="id_nvInput" placeholder="NV001">
            </div>
            <div class="mb-3">
               <label class="form-label">Họ và tên:</label>
               <input type="text" class="form-control" name="hoten" id="hotenInput" placeholder="Nguyễn Văn A">
            </div>
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control" name="diachi" id="diachiInput" placeholder="Hà Nội">
            </div>

            <div class="mb-3">
               <label class="form-label">Lương:</label>
               <input type="text" class="form-control" name="luong" id="luongInput" placeholder="10000000">
            </div>

            <div class="mb-3">
               <label class="form-label">Tài khoản:</label>
               <input type="text" class="form-control" name="taikhoan" id="taikhoanInput" placeholder="Username">
            </div>

            <div class="mb-3">
               <label class="form-label">Mật khẩu:</label>
               <input type="password" class="form-control" name="matkhau" id="matkhauInput" placeholder="Password">
            </div>
