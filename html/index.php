...
<html lang="en">
  ...
  <body>
    ...
    <!--=====================================
        TEAM START
    =====================================-->
    <section class="tf__team mt_115 xs_mt_65">
      <div class="container">
        <div class="row">
          <div
            class="col-xl-7 col-md-10 m-auto wow fadeInUp"
        ...
        <div class="row">
          ...
          >
            <div class="tf__single_team">
              ...
              <div class="tf__single_team_text">
                <a class="title" href="team_details.html">Tan</a>
                <p>Founder</p>
              </div>
            </div>
          </div>
          ...
          >
            <div class="tf__single_team">
              ...
              <div class="tf__single_team_text">
                <a class="title" href="team_details.html">Sy</a>
                <p>Founder</p>
              </div>
            </div>
          </div>
          ...
          >
            <div class="tf__single_team">
              ...
              <div class="tf__single_team_text">
                <a class="title" href="team_details.html">Son</a>
                <p>Founder</p>
              </div>
            </div>
          </div>
